...
%% ===================== INTENT LAYER =====================
A[🎯 Intent Layer<br/>OKRs • Strategy Docs • Leadership Claims] --> D

%% ===================== SIGNAL LAYER =====================
B[📡 Signal Layer<br/>Slack • Jira • Meetings • Emails] --> D

%% ===================== DATA ENGINE =====================
D[🧠 Context Construction Engine<br/>Signal Normalization + Structuring] --> E

%% ===================== MEMORY GRAPH =====================
E[🧬 Organizational Memory Graph<br/>Entity + Relationship Mapping] --> F
...
G1[🧠 Strategic IQ<br/>Intent vs Execution Alignment] --> H
G2[⚠️ Risk IQ<br/>Failure Trajectory Detection] --> H
G3[👤 Behavioral IQ<br/>Human Incentive Modeling] --> H

%% ===================== CONTRADICTION ENGINE =====================
H[⚡ Contradiction Detection Engine<br/>Mismatch • Drift • Blind Spots] --> I

%% ===================== FORECASTING =====================
I[🔮 Predictive Forecast Layer<br/>30/60/90 Day Risk Simulation] --> J

%% ===================== OUTPUT =====================
J[📊 Insight Dashboard<br/>Divergence Score • Drift Index • Executive Blind Spots]

%% ===================== META =====================
K[⚙️ Copilot-Assisted Development Layer<br/>GitHub Copilot + AI Iteration] -.-> D
K -.-> E
K -.-> H
